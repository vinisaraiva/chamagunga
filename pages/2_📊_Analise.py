...
create_card(col1, data['respostas'][0]['titulo'], data['respostas'][0]['conteudo'])
create_card(col2, data['respostas'][1]['titulo'], data['respostas'][1]['conteudo'])

# Adicionar o terceiro card na segunda linha
col3 = st.empty()
create_card(col3, data['respostas'][2]['titulo'], data['respostas'][2]['conteudo'])
